...
The datasets are from data NSW government website. Three datasets contains notification date, confirmed cases location and cases source. There are some biases on data. Such as, the cases may not all cases in NSW because some people were not tested. 
...
##Plot heatmap
Below I give the population affected for Australia.
```{r echo=FALSE, message=FALSE, warning=FALSE, r,warning=FALSE}
#data
...
## All larger regions
<iframe src="https://public.tableau.com/views/changesofregionsyearbar/Sheet3?:showVizHome=no&:embed=true"width="800"height="830"></iframe>
...
## SW Sydney
<iframe src="https://public.tableau.com/views/casestableofSWSydney/Sheet5?:showVizHome=no&:embed=true"width="800"height="600"></iframe>
...
<iframe src="https://public.tableau.com/views/sourcetableofSWSydney/Sheet3?:showVizHome=no&:embed=true"width="800"height="600"></iframe>
...
<h2>Conclusion</h2>
Four conclusions and advice can be found from all above data and graphs. First, the coastal areas, especially the Sydney metropolitan area, have the highest infection rate. People should pay attention to protection when going to these areas. Second, there are many infected people in residential areas and many cases have not been traced to the source. This means that as long as you go out of the house, you must wear a mask. The government should improve the checkin system as soon as possible. Third, people in age groups 0-19 and 70+ should get vaccinated as soon as possible and wear masks in their daily lives.
